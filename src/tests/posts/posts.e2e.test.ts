...
describe("get all /posts", () => {
  ...
  let createdPost: PostViewDtoTypeorm;
...
describe("create comment for post /posts/:id/comments", () => {
  connectToTestDBAndClearRepositories();
...
describe("get all comments for post /posts/:id/comments", () => {
  connectToTestDBAndClearRepositories();

  let createdComment: CommentViewDtoTypeorm;
